    ...
    connection.query("SELECT * FROM role", (err, results) => {
        ...
        connection.query("SELECT * FROM employee", (err, results) => {
            ...
            inquirer
                ...
                .then((response) => {
                    connection.query("INSERT INTO employee(first_name,last_name,manager_id,role_id) VALUES (?,?,?,?)", [response.firstName, response.lastName, response.managerId, response.roleId], (err, results) => {
                        connection.query("SELECT * FROM employee", (err, results) => {
                            console.table(results)
                            mainMenu()
                        })
